...
Follow the code cells in `Navigation.ipynb` after the tutorial to train the agent!  
* Load the trained agent weights from the `checkpoints.pth` file to see the agent in action
